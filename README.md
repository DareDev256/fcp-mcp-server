...
[![Tests](https://img.shields.io/badge/tests-1180_passing-brightgreen.svg)](#testing)
[![Suites](https://img.shields.io/badge/suites-27-blue.svg)](#testing)

**Hardened for real libraries:** 167 adversarial-input security tests, `defusedxml` everywhere, sandboxed writes, no patched binaries, no private APIs — plus a [private disclosure channel](SECURITY.md) with externally reported fixes already credited and merged.
...
├── tests/                 1184 tests across 27 suites (1180 pass, 4 skip without ffmpeg/FCP)
